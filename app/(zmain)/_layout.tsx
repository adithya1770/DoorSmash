...
const _layout = () => {
  return (
    <Tabs screenOptions={{tabBarStyle: {backgroundColor: "#000000", borderTopWidth: 0}}}>
        ...
        <Tabs.Screen name="contact" options={{title: 'Profile', tabBarIcon: ({color, size}) => <Ionicons name="settings" size={22} color="white"/>, headerShown: false, tabBarLabelStyle: { fontFamily: 'UrbanBold' ,fontSize: 10, color: "white"}}}/>
    </Tabs>
  )
}
